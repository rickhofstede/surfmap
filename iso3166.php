<?php
	...
	$ISO3166_COUNTRY_CODE_TO_NUMBER = array(
	...
	function isValidCountryCode ($countryCode) {
		global $ISO3166_COUNTRY_CODE_TO_NUMBER;
		
		$countryNumber = -1;
		foreach ($ISO3166_COUNTRY_CODE_TO_NUMBER as $code => $number) {
	...
	function isValidCountryName ($countryName) {
		global $ISO3166_COUNTRY_NAMES;
		
		foreach ($ISO3166_COUNTRY_NAMES as $name) {
	...
	function getCountryNameFromCode ($countryCode) {
		global $ISO3166_COUNTRY_CODE_TO_NUMBER, $ISO3166_COUNTRY_NAMES;
		...
		return $ISO3166_COUNTRY_NAMES[$countryNumber];
	}
